...
helper executable is F</usr/local/libexec/qemu-bridge-helper>.
...
F</usr/local/libexec/qemu-bridge-helper> and the default bridge
device is F<br0>.
...
Output log in I<logfile> instead of /tmp/qemu.log
